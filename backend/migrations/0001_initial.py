    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ManyToManyField(blank=True, to='backend.DoctorDetails')),
            ],
        ),
        migrations.CreateModel(
            name='VitalDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.doctordetails')),
