    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('doctor', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='backend.doctordetails')),
            ],
        ),
        migrations.CreateModel(
            name='VitalDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='problem_patient', to='backend.patientdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Medication',
            fields=[
                ...
                ('doctor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.doctordetails')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='patient_med', to='backend.patientdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Dosage',
