...
class Medication(models.Model):
    patient = models.OneToOneField(PatientDetails, on_delete=models.PROTECT, related_name='patient_med')
    doctor = models.OneToOneField(DoctorDetails, on_delete=models.SET_NULL, null=True)
...
class SocialHistory:
    ...
    tobacco = models.CharField(choices=SMOKE_STATUS, default="Never Smoked")
    alcohol = models.CharField(choices=DRINK_STATUS, default="Current Drinker")
    patient = models.ForeignKey(PatientDetails, on_delete=models.PROTECT, related_name='patient_smoker')
